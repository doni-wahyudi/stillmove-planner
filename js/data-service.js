...
class DataService {
    ...
    /**
     * Get activity log entries for a specific board within a date range
     * @param {string} boardId - Board ID
     ...
     */
    async getKanbanActivityLogRange(boardId, startDate, endDate) {
        try {
            const cards = await this.getKanbanCards(boardId);
